...
/*   Updated: 2020/02/12 18:55:33 by ccardozo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	s_undefbehav_0_2zero_lj(void){return ft_printf("%00s", s_hidden);}
// zero and width
...
int	s_undefbehav_0_2zero_lj_bench(void){return printf("%00s", s_hidden);}
// zero and width
...
const t_test_entry g_unit_tests[] = {
	...
	{1, 128, "s_undefbehav_0_2zero_lj", s_undefbehav_0_2zero_lj, s_undefbehav_0_2zero_lj_bench, "{return test(\"%00s\", s_hidden);}"},
